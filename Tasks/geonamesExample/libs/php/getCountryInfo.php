<?php
	...
	$url = 'http://api.geonames.org/postalCodeLookupJSON?formatted=true&postalcode=' . $_REQUEST["postalcode"] . '&country=' . $_REQUEST["country"] . '&username=manpreetKaur&style=full';
